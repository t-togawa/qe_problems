...
[[ # (2)
  ...
  Ex([x], And(x^2-a*x=0, 2*x-a>0, 2*x^3-3*a*x^2 <= 2*(-1)^3-3*a*(-1)^2, a>0)),
  a >= 2
], [ # (3)'
  Ex([x], And(-1 <= x, x <= 3, 6*k=2*x^3-3*a*x^2, a>0)),
  Or(And(0<a,a<=2, (-3*a-2) <= 6*k, 2*k <= (18-9*a)),
     And(2<a,a<=3, -a^3 <= 6*k, k <= 0),
     And(a>3, (18-9*a) <= 2*k, k <= 0))
], [ # (3)
  Ex([x], All([x0], Impl(And(-1 <= x0, x0 <= 3),
    And(-1 <= x, x <= 3, 6*k=2*x^3-3*a*x^2, a>0, k <= 2*x0^3-3*a*x0^2)))),
