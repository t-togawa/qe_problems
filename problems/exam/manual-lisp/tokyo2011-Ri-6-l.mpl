...
Or(And(4*x0*x5-x2^2 = 0,-x2-4*x5 <= 0,x2+2*x5 < 0),And(x2 < 0,4*x0^2+4*x0*x2-4*
x0*x5+x2^2 = 0,-x0+x5 < 0,-x2-4*x5 <= 0),And(-x2-2*x5 <= 0,x0+x2+x5 = 0,x2+x5 <
0),And(-x2 <= 0,x0+x2-x5 = 0,x2-x5 < 0))
]]:
