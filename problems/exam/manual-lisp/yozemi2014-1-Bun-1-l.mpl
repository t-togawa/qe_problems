...
[
[Ex([x0],And(Ex([x3],And(-x3 <= 0,x2-3*x3 = 0,x3 <= 1,-9*x3^2+4*x1+18*x3-4 = 0)),-x0 <= 0,x0 <= 1,2*x0+x1-2 = 0)),
And(-x1<=0,x1<=2,3*x2+4*x1<=4,-x2^2+4*x1+6*x2-4=0)],
[Ex([x0, x2],And(-x0 <= 0,-x2 <= 0,x0 <= 1,x1-3*x2 = 0,x2 <= 1,9*x2^2+8*x0-18*x2-4 = 0)),
...
[Ex([x0, x1],And(Or(-x0*x1+x0 <= 1,3*x0*x1-3*x0+x2+3 = 0),Or(x0*x1-x0 < -1,3*x0*x1-3*x0-x2+3 = 0),Or(3*x0*x1-3*x0-x2+3 = 0,3*x0*x1-3*x0+x2+3 = 0),-x0 <= 0,-x1 <= 0,x0 <= 1,x1 <= 1,9*x0^2-18*x0+8*x1-4 = 0)),
